...
const testimonials = [
  ...
  { name: "Fatima Z.", text: "The best gym in Casablanca. Clean, professional, and the community is incredible.", rating: 5 },
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Victory Gym" className="w-full h-full object-cover" />
