  ...
  return (
    <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
      ...
      <motion.a
        ...
        className="w-14 h-14 rounded-full flex items-center justify-center shadow-lg whatsapp-pulse hover:scale-110 transition-transform"
